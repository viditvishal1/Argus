  ...
  return (
    <div className="-mx-4 space-y-4 pb-14 md:-mx-6">
      ...
      <section className="relative h-[min(62vh,680px)] w-full overflow-hidden border-y border-line bg-black">
        ...
        <div className="hud-window absolute right-3 top-3 z-10 flex w-48 max-h-[min(640px,calc(100%-1.5rem))] flex-col gap-1 overflow-y-auto rounded-lg px-2.5 py-2 sm:top-[3.75rem]">
