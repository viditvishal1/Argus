...
for (const m of ["004_dashboard_panels.sql", "005_observations_tracks.sql", "006_provider_governance.sql", "007_alerts_search_ops.sql", "008_user_auth_rls.sql", "009_org_members.sql", "010_preferences_push.sql"]) {
